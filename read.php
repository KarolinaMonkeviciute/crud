...
<head>
    ...
    <title>Read</title>
    <script src="http://localhost/bit/crud/app.js" defer></script>
</head>
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <a href="http://localhost/bit/crud/edit.php?id=<?= $box['boxId'] ?>" class="btn btn-outline-info btn-sm">Edit</a>
                        <a href="http://localhost/bit/crud/delete.php?id=<?= $box['boxId'] ?>" class="btn btn-outline-danger btn-sm">Delete</a>
                    </div>
                </div>
            </div>
        </li>
